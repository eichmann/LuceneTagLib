...
public class LuceneSearch extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			theHits = searchIndex(theSearcher, queryString, 1000,theQueryParser);
	...
	private static TopDocs searchIndex(IndexSearcher searcher, String queryString, int n, QueryParser theQueryParser) throws IOException {
		TopDocs myHits = null;
		boolean retry = true;
		while (retry) {
			try {
