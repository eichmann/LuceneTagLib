...
<YYINITIAL> \( / {TERMINATION}*{WHITE_SPACE_CHAR}							{ return (new Symbol(edu.uiowa.lucene.booleanSearch.BooleanParseSym.LPAREN, yytext()));
							}

<YYINITIAL> \) / {TERMINATION}*{WHITE_SPACE_CHAR}							{ return (new Symbol(BooleanParseSym.RPAREN, yytext()));
							}

<YYINITIAL> \& / {TERMINATION}*{WHITE_SPACE_CHAR}							{ return  (new Symbol(BooleanParseSym.AND_OP, yytext()));
							}

<YYINITIAL> \| / {TERMINATION}*{WHITE_SPACE_CHAR}							{ return (new Symbol(BooleanParseSym.OR_OP, yytext()));
							}

<YYINITIAL> \! / {TERMINATION}*{WHITE_SPACE_CHAR}							{ return (new Symbol(BooleanParseSym.NOT_OP, yytext()));
							}

<YYINITIAL> [\r\n] / {TERMINATION}*{WHITE_SPACE_CHAR}						{ return (new Symbol(BooleanParseSym.EOF, yytext()));
							}
...
<YYINITIAL> {WHITE_SPACE_CHAR}+ {
	//return (new Symbol(BooleanParseSym.String, yytext()))," ",yyline));
	}
